...
def status_embed(motd: str, ip: str, version: str, online_players_count: int, max_players_count: int,
    ...
    embed.set_author(name="Rumblur Classic", url="https://rumblur.space",
                     icon_url="https://rumblur.space/images/chainfire.png")
    embed.set_thumbnail(url="https://rumblur.space/images/chainfire.gif")
...
def admin_crash_embed(message: str) -> Embed:
    ...
    embed.set_author(name="Having troubles...", icon_url="https://rumblur.space/images/block.png")
    embed.set_thumbnail(url="https://rumblur.space/images/sadcat.png")
    embed.set_footer(text="Alerted by Rusty", icon_url="https://rumblur.space/images/paws.png")
    return embed
